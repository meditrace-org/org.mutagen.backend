...
class QualityTestQueryMapper : GeneralFetcher() {
    ...
    companion object {
        private val diffSizes = RuntimeException("Expected result and test videos arrays has different lengths.")
        private val diffContent = RuntimeException("Expected result and test videos contains different videos.")
    }
    ...
    fun doFetch(qualityTestRequest: QualityTestRequest): QualityTestData {
        ...
        val strategies = qualityTestRequest.strategies ?: SqlScriptsConfig.getAllStrategies()
